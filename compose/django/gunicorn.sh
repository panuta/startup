...
/usr/local/bin/gunicorn config.wsgi -w 4 -b /var/run/django.sock --chdir=/app --access-logfile /var/log/gunicorn.out.log --error-logfile /var/log/gunicorn.err.log --capture-output
